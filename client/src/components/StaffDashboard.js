...
import { getFees } from '../../src/actions/feesActions'; 
...
const StaffDashboard = () => {
  ...
  return (
    <div className="p-4">
      <h1 className="text-4xl font-bold mb-4 pb-5">Staff Dashboard</h1>
      <h2 className="text-xl mb-2  font-bold pb-3">Students Fees List</h2>
